...
export const StageMenu = ({ currentId }) => {
  ...
  /* Ditutup lewat pointerdown, bukan click: klik pada tautan di dalam menu akan
     menavigasi dan melepas komponennya sebelum click sempat menggelembung.
     pointerdown selalu lebih dulu. */
  useEffect(() => {
    if (!open) return;
    const onDown = (e) => {
  ...
  /* stopPropagation untuk SEMUA panah, bukan cuma yang dipakai di sini:
     ProfileSection memasang pendengar panah kiri/kanan di window, dan tanpa
     penghenti ini menavigasi menu ikut menggeser panggung di belakangnya.
     Selama menu terbuka, panah milik menu. */
  const onKeyDown = (e) => {
  ...
  return (
    <div ref={rootRef} className="relative" onKeyDown={onKeyDown}>
      ...
      >
        Stage
        {/* Segitiga berbalik saat terbuka - bahasa yang sama dengan panel babak. */}
