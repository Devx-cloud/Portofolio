...
const skills = [
    ...
    {name: "laravel", level: 65, category: "backand"},
    {name: "git", level: 95, category: "tools"},

]

const category = ["all", "frontend", "backand", "tools"]


export const SkillSection = () => {
    const [activeCategory, setActiveCategory] = useState("all")
    const fillteredSkill = skills.filter((skill) => activeCategory === "all" || skill.category === activeCategory)
