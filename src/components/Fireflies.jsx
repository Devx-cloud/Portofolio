 ...
 * lurus ke atas - vektor tunggal kerasa kaku. Tiap partikel jalan lewat 4
 * titik acak (fx/fy 1-4) dan kedipnya dijalankan sebagai animasi terpisah
 * dengan durasi/delay sendiri, jadi gerak dan kedip tidak pernah sinkron
 * satu sama lain.
 *
 * Posisi & lintasan dibangkitkan sekali lewat PRNG bersemai supaya stabil
 * antar render - Math.random() di badan komponen akan mengocok ulang tiap
 * render, dan komponen ini ikut ter-render setiap babak berganti.
 */
